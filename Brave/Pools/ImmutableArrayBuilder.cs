...
internal ref struct ImmutableArrayBuilder<T>
{
    ...
    /// <summary>
    /// Gets or sets an element at a specified index in the builder.
    /// </summary>
    public T this[int index]
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get => writer![index];
    ...
    private sealed class Writer : ICollection<T>, IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets an element at a specified index in the writer buffer.
        /// </summary>
        public T this[int elementIndex]
        {
            ...
            get
            {
                if ((uint)elementIndex >= (uint)index)
                {
